# Generated by Django 4.2 on 2023-09-18 07:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name_en', models.CharField(blank=True, max_length=100, null=True, verbose_name='Имя')),
                ('last_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='Фамилия')),
                ('last_name_en', models.CharField(blank=True, max_length=100, null=True, verbose_name='Фамилия')),
                ('middle_name', models.CharField(blank=True, max_length=100, null=True)),
                ('passport_number', models.CharField(blank=True, max_length=100, null=True, verbose_name='Номер паспорта')),
                ('doc_type_id', models.CharField(blank=True, max_length=100, null=True)),
                ('doc_type', models.CharField(blank=True, max_length=512, null=True, verbose_name='Тип документа')),
                ('doc_expiry_date', models.CharField(blank=True, max_length=100, null=True)),
                ('doc_issued_by', models.CharField(blank=True, max_length=256, null=True)),
                ('doc_issued_by_id', models.CharField(blank=True, max_length=256, null=True)),
                ('doc_type_id_cbu', models.CharField(blank=True, max_length=256, null=True)),
                ('doc_issued_date', models.CharField(blank=True, max_length=256, null=True)),
                ('citizenship', models.CharField(blank=True, max_length=100, null=True, verbose_name='Гражданство')),
                ('citizenship_id', models.CharField(blank=True, max_length=100, null=True)),
                ('citizenship_id_cbu', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('nationality_id_cbu', models.CharField(blank=True, max_length=100, null=True)),
                ('birth_country', models.CharField(blank=True, max_length=100, null=True)),
                ('birth_country_id', models.CharField(blank=True, max_length=100, null=True)),
                ('birth_country_id_cbu', models.CharField(blank=True, max_length=100, null=True)),
                ('birth_place', models.CharField(blank=True, max_length=100, null=True, verbose_name='Место рождения')),
                ('sdk_hash', models.CharField(blank=True, max_length=256, null=True)),
                ...
                ('region_id', models.CharField(blank=True, max_length=100, null=True)),
                ('region_id_cbu', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('district_id_cbu', models.CharField(blank=True, max_length=100, null=True)),
