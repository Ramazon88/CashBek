...
SECRET_KEY = 'django-insecure-%a(da41^%)vpo+51xlyakdsmcek29awm!edx=10y@oxjh^gcia'
...
FORMATTERS = (
    {
        "verbose": {
            "format": "{levelname} {asctime:s} {name} {module} {filename} {funcName} {message}",
            "style": "{",
        },
        "simple": {
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to the CashBek",
